...
# 1st Attempt
# LOGIC: save address of random ip hash map and retrieve
# Time: O(n)  | Space: O(n)
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        deepcopy = copied.next

        while deepcopy:
            deepcopy.random = hash_map.get(hash_map_original.get(deepcopy.random))
