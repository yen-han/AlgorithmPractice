...
| Leet605  | [Can Place Flowers](Greedy/Leet605_canPlaceFlowers.js)                                | JavaScript | O(n)             | O(1)  | Check the number of space that can place flowers.     |
...
|   No    | Title                                                 | Type        | Language   | Time    | Space | Description                              |
| :-----: | ----------------------------------------------------- | ----------- | ---------- | ------- | ----- | ---------------------------------------- |
| Leet463 | [Island Perimeter](Search/Leet463_islandPerimeter.js) | Depth-first | JavaScript | O(n)    | O(1)  | Find perimeter on an island.             |
| Leet704 | [Binary Search](Search/Leet704_binarySearch.js)       | Binary      | JavaScript | O(logn) | O(1)  | Find target number with logn complexity. |
| Leet733 | [Flood Fill](Search/Leet733_floodFill.js)             | Depth-first | JavaScript | -       | O(1)  | Apply new color in an image.             |
...
| Leet14  | [Longest Common Prefix](String/Leet14_longestCommonPrefix.js)         | JavaScript | O(s)             | O(1)  | Find the longest prefix among strings.                          |
