...
|  Leet1   | Two Sum                             | [JavaScript](Array/Leet1_twoSum.js), [Java](Array/Leet1_twoSum.java) | O(n<sup>2</sup>)        | O(1)         | Easy   | Find indices of two numbers that add up to the target.                 |
