...
| Leet83  | Remove Duplicates from Sorted List    | [python3](Linked-List/Leet82_remove_duplicates_from_sorted_list.py)                                                         | O(n)             | O(1)        | Easy   | delete all nodes that have duplicate numbers.                         |           |
