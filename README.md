...
|  Leet5  | Longest Palindromic Substring                  | [JavaScript](String/Leet5_longestPalindromicSubstring.js)                                | O(n^3)                | O(1)  | Medium | find the longest palindromic substring in the string.                  |                     |
