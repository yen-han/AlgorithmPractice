...
| Leet64  | Minimum Path Sum         | [JavaScript](Dynamic-Programming/Leet64_minimumPathSum.js)         | O(m\*n)          | O(m\*n) | Medium | Minimizes the sum of all numbers from left-top to right-bottom. |
