...
|   No    | Title                            | Language                                                                                                      | Time             | Space       | Level  | Description                                                           | Notes     |
| :-----: | -------------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------- | ----------- | ------ | --------------------------------------------------------------------- | --------- |
|  Leet2  | Add Two Numbers                  | [Java](Linked-List/Leet2_addTwoNumbers.java), [JavaScript](codingPractice/Linked-List/Leet2_addTwoNumbers.js) | O(max(m,n))      | O(n)        | Medium | Create new linked list with sum of two linked list.                   | Recursive |
...
|   No    | Title                                          | Language                                                                                 | Time                  | Space | Level  | Description                                                            | Notes          |
| :-----: | ---------------------------------------------- | ---------------------------------------------------------------------------------------- | --------------------- | ----- | ------ | ---------------------------------------------------------------------- | -------------- |
|  Leet3  | Longest Substring Without Repeating Characters | [JavaScript](String/Leet3_LongestSubstringWithoutRepeatingCharacters.js)                 | O(n)                  | O(n)  | Medium | find the length of the longest substring without repeating characters. | Sliding window |
