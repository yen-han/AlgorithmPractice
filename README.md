...
| Leet231  | Power of Two     | [JavaScript](Math/Leet231_powerOfTwo.js)      | -       | O(1)    | Easy   | Check if the number is power of two.      |
| Leet326  | Power of Three   | [JavaScript](Math/Leet326_powerOfThree.js)    | -       | O(1)    | Easy   | Check if the number is power of three.    |
